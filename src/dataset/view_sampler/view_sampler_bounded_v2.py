...
class ViewSamplerBoundedV2Cfg:
    ...
    extra_views_sampling_strategy: Optional[
        Literal["random", "farthest_point", "equal"]
    ] = "random"
    ...
    def sample(
        ...
        if self.stage == "test":
            ...
            if self.cfg.target_views_replace_sample:
                ...
                indices = torch.randperm(
                    index_target_right + 1 - index_target_left, device=device
        ...
        if total_num_views > 2:
            ...
            if self.cfg.extra_views_sampling_strategy == "random":
                ...
                context_bounded_index = torch.arange(
                    index_context_left, index_context_right + 1
                )
                candidate_views_position = extrinsics[
                    context_bounded_index, :3, -1
                ].unsqueeze(0)
